...
# In[ ]:
 ...
 #    get_ipython().system('accelerate launch --num_cpu_threads_per_process=8 "./sd-scripts/train_network.py"   --enable_bucket   --pretrained_model_name_or_path=$pretrained_model   --train_data_dir=$train_data_dir   --output_dir="./output"   --logging_dir="./logs"   --resolution=$resolution   --network_module=networks.lora   --max_train_epochs=$max_train_epoches   --learning_rate=$lr   --unet_lr=$unet_lr   --text_encoder_lr=$text_encoder_lr   --network_dim=$network_dim   --network_alpha=$network_alpha   --output_name=$output_name   --lr_scheduler=$lr_scheduler   --train_batch_size=$batch_size   --save_every_n_epochs=$save_every_n_epochs   --mixed_precision="fp16"   --save_precision="fp16"   --seed="1337"   --cache_latents   --clip_skip=$clip_skip   --prior_loss_weight=1   --max_token_length=225   --caption_extension=".txt"   --save_model_as=$save_model_as   --xformers --shuffle_caption --use_8bit_adam')
